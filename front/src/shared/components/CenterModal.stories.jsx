...
const ExampleContent = ({ label }) => (
  <div className="text-sm text-gray-600 p-2">
    <p><strong>{label}:</strong> Esta es una sección de contenido de ejemplo.</p>
    <p className="mt-2">Podés renderizar cualquier componente aquí.</p>
  </div>
);
...
<ReusableModal
  ...
  tabs={[
    { label: 'ODF', key: 'odf', content: <Odf /> },
    { label: 'Conectividad', key: 'conectividad', content: <Conectividad /> },
    { label: 'Divicau', key: 'divicau', content: <FTTHDesigner /> }
  ]}
/>
